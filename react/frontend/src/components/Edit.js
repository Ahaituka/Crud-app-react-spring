...
class Edit extends Component {
  ...
  componentDidMount() { //lifecycle method when component is mounted
  ...
  onChange = (e) => {
    ...
    state[e.target.name] = e.target.value; //index of the selected contact
  ...
  onSubmit = (e) => {
    ...
    axios.put('/contacts/'+this.props.match.params.id, { name, address, city, postalCode, phone }) //pass the data
      .then((result) => {
